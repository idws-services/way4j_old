...
public class ModelUtils {
	...
	public static Class getModelClass(String className) {
		return searchClass(className,
				new String[] { packageLocations.getModel() });
	}
	...
	public static Class getControllerOfModel(Class clazz)
			throws ClassNotFoundException {
		return searchClass(getClassName(clazz) + Constants.CONTROLLER_SUFIX,
				new String[] { packageLocations.getController() });
	}

	public static Class getDaoOfModel(Class clazz)
			throws ClassNotFoundException {
		return searchClass(getClassName(clazz) + Constants.DAO_SUFIX,
				new String[] { packageLocations.getDao() });
	}

	public static Class getServiceOfModel(Class clazz)
			throws ClassNotFoundException {
	...
	public static boolean implementsClass(Field f, Class intfc) {
		Class[] intfcs = f.getType().getInterfaces();
		for (Class c : intfcs) {
			if (c.equals(intfc)) {
				return true;
			}
